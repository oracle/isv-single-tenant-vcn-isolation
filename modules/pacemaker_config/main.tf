variable hostname {}
variable instance1_primary_vnic_id {} // module.routing_instance.instance_vnics[0]
variable instance1_secondary_vnic_id {} // module.routing_vnic_attachement1.routing_secondary_vnic_id
variable instance2_primary_vnic_id {} // module.routing_instance.instance_vnics[1]
variable instance2_secondary_vnic_id {} // module.routing_vnic_attachement2.routing_secondary_vnic_id
...
locals {
  pacemaker_config = [
    ...
    "sudo sed -i '66i\\vrouter1vnic=\"${var.instance1_primary_vnic_id}\"\\' /usr/lib/ocf/resource.d/heartbeat/IPaddr2",
    "sudo sed -i '67i\\vrouter1vnicpod1=\"${var.instance1_secondary_vnic_id}\"\\' /usr/lib/ocf/resource.d/heartbeat/IPaddr2",
    "sudo sed -i '68i\\vrouter2vnic=\"${var.instance2_primary_vnic_id}\"\\' /usr/lib/ocf/resource.d/heartbeat/IPaddr2",
    "sudo sed -i '69i\\vrouter2vnicpod1=\"${var.instance2_primary_vnic_id}\"\\' /usr/lib/ocf/resource.d/heartbeat/IPaddr2",
